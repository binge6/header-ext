...
const COPY = {
  "zh-CN": {
    title: "页面出错了",
    description: "扩展遇到未预期的错误。可尝试重新加载；若反复出现，请检查或重置数据。",
    reload: "重新加载",
  },
  "en-US": {
...
function resolveCopy(): (typeof COPY)[keyof typeof COPY] {
  return i18n.language?.startsWith("zh") ? COPY["zh-CN"] : COPY["en-US"];
}
  ...
  render(): ReactNode {
    ...
    return (
      <div className="he-error-boundary" role="alert">
        ...
        <pre className="he-error-boundary-detail">{this.state.error.message}</pre>
